#ifndef HTTP_OBJ_HTTP
#define HTTP_OBJ_HTTP
...
namespace http 
{
    ...
    class OBJ_VALUE
    {
        ...
        OBJ_VALUE& set_float()   {    type_t = FLOAT; return *this; }
        OBJ_VALUE& set_int()   {    type_t = INT; return *this; }
        OBJ_VALUE& set_string()   { type_t = STRING; return *this; }
        OBJ_VALUE& set_array()   {  type_t = ARRAY; return *this; }
        OBJ_VALUE& set_null()   {   type_t = NIL; return *this; }
